...
WIDTHS_EXAMPLE_FILE = os.path.join(ROOT_DIRECTORY, "tests", "streamlit_apps", "example_return_widths.py")
...
def test_should_display_width_information(page: Page):
    ...
    expect(page.get_by_text("Test Expandable Columns with Width Tracking")).to_be_visible()
