...
E2E_TEST_APP = os.path.join(ROOT_DIRECTORY, "tests", "streamlit_apps", "example_basic_columns.py")
...
def go_to_app(page: Page, streamlit_app: StreamlitRunner):
    ...
    page.wait_for_selector('iframe[title="streamlit_expandable_columns.streamlit_expandable_columns"]', state="attached", timeout=60000)
...
def get_column_widths(page: Page) -> list[float]:
    ...
    return page.locator('div[data-testid="stVerticalBlock"] > div[data-testid="stHorizontalBlock"] > div').all_bounding_boxes()
...
def test_column_resize(page: Page):
    ...
    iframe = page.frame_locator('iframe[title="streamlit_expandable_columns.streamlit_expandable_columns"]')
    ...
    page.mouse.move(handle_bb["x"] + handle_bb["width"] / 2, handle_bb["y"] + handle_bb["height"] / 2)
    page.mouse.down()
